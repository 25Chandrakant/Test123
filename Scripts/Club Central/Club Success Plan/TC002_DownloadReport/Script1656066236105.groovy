...
try {
    ...
    WebUI.click(findTestObject('Object Repository/ClubCentral/Club Success Plan/i_CJ Frey_fa fa-unlock'))

    WebUI.click(findTestObject('Object Repository/ClubCentral/Club Success Plan/a_Download File'))

	
	'Replace File'
    WebUI.click(findTestObject('Object Repository/ClubCentral/Club Success Plan/i_CJ Frey_fa fa-unlock'))

    WebUI.click(findTestObject('Object Repository/ClubCentral/Club Success Plan/a_Replace'))

	WebUI.sendKeys( findTestObject('Object Repository/ClubCentral/Club Success Plan/input_Browse files to upload_fileToUpload')  , "D://GitProject//290h-moments-of-truth-handout_2021.pdf")
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Club Success Plan/i_Download File_fa fa-close'))) {
        ...
        GlobalVariable.varpassremarks = 'User Successfully Download file'
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unble to downlaod file'
    }
