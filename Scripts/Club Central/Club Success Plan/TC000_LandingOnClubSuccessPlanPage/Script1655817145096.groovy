...
try {
	...
	WebUI.click(findTestObject('Object Repository/ClubCentral/Club Success Plan/div_ClubName'))
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Club Success Plan/h1_ClubSuccessPlan'))) {
