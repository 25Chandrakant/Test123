...
try {
   ...
   CustomKeywords.'com.application.DPOSCustomKeyword.needSomeHelpCloseButton'()
	...
	if(WebUI.verifyElementVisible( findTestObject('Object Repository/ClubCentral/Leadership-Home/i_Club Success Plan_fa fa-close') )){
		WebUI.click(findTestObject('Object Repository/ClubCentral/Leadership-Home/i_Club Success Plan_fa fa-close'))
		
		
	}
	
	WebUI.click(findTestObject('Object Repository/ClubCentral/Club_Event/div_Club Events')  )
    ...
    if (WebUI.verifyElementVisible( findTestObject('Object Repository/ClubCentral/Club_Event/h1_ClubEventTag'))) {
        ...
        GlobalVariable.varpassremarks = 'User Successfully landing on Club Event page.'
    } else {
        print('FAIL...............................')

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to Club Event Page.'
    }
