...
try {
	...
	WebUI.switchToFrame(findTestObject('Object Repository/Club_Officer_Assigment/Future/iframe_Object'));
	...
	if (WebUI.waitForElementVisible(findTestObject('Object Repository/Club_Officer_Assigment/Future/validation_message'),150)) {
