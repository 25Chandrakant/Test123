...
try {
    ...
    WebUI.click(findTestObject('Object Repository/Club_Officer_Assigment/CurrentMember/div_Club Officer Assignment'))

    if (WebUI.waitForElementVisible(findTestObject('Object Repository/Club_Officer_Assigment/CurrentMember/h1_Club Officer Assignment'), 
        150)) {
 
        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'User Successfully landing on Club Officer Assignment page.'
    } else {
 
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to Club Officer Assignment page.'
    }
