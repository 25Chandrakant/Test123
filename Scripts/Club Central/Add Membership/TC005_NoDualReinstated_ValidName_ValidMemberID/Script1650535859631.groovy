...
try {
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Add_Membership/No, Dual_Reinstated Member/a_Submit Payment'))) {
		...
		WebUI.callTestCase(findTestCase('Club Central/Add Membership/TC008_AddToCart'), [:], FailureHandling.STOP_ON_FAILURE)
		
    } else if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Add_Membership/Address/select_byLabelCountry'))) {
