...
try {
    ...
    WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/h1_Overview'), 
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/button_back'), 
        FailureHandling.OPTIONAL)) {
        WebUI.click(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/button_back'), 
            FailureHandling.OPTIONAL)
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/Input_ClubName'))) {
        ...
        WebUI.waitForElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/validation_Message_name of your club'), 
    ...
    WebUI.waitForElementNotVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_Does your club have any restrictions on membership_MainQuestions0.Answer'), 
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_Academy  University_option1'))) {
        ...
        WebUI.click(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_YesButton_Other'), 
            FailureHandling.OPTIONAL)

        if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/a_Explain_Other'), 
            FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/a_Explain_Other'), 
                FailureHandling.OPTIONAL)

            WebUI.clearText(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/InputText_ExplainHere'), 
                FailureHandling.OPTIONAL)

            WebUI.sendKeys(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/InputText_ExplainHere'), 
                GlobalVariable.TestData['OtherExplainHere'])
        }
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_Does your club allow honorary memberships_MainQuestions2.Answer'))) {
        ...
        WebUI.click(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_Does your club allow honorary memberships_MainQuestions2.Answer_NO'), 
            FailureHandling.OPTIONAL)

        WebUI.verifyElementNotVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/select_Select Length'), 
            FailureHandling.OPTIONAL)
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_Does your club collect fees other than Toastmasters membership dues_MainQuestions1.Answer'))) {
        ...
        WebUI.waitForElementClickable(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/input_Does your club collect fees other than Toastmasters membership dues_MainQuestions1.Answer_NO'), 
        ...
        if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/h1_Regular and Executive Committee Meetings'), 
            FailureHandling.OPTIONAL)) {
            WebUI.click(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/button_back'))
        }
    ...
    if (WebUI.verifyElementPresent(findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/a_Club Contact and Meeting Info'), 
		...
		WebUI.click( findTestObject('Object Repository/ASCO/Page_Toastmasters International -Club Visit Report/a_Club Contact and Meeting Info') , FailureHandling.OPTIONAL)
