...
try {
    ...
    WebUI.click(findTestObject('Object Repository/ASCO/div_Addendum of Standard Club Options'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ASCO/h1_Addendum of Standard Club Options'), 150)) {
        print('PASS...............................')

        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'User Successfully landing on Addendum of Standard Club Options page.'
    } else {
        print('FAIL...............................')

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to Addendum of Standard Club Options page.'
    }
