...
try {
	...
	WebUI.scrollToPosition(00000, 00000)
	...
	print('....................................................')
    'To locate table'
    WebElement Table = driver.findElement(By.xpath('(//table[@role="presentation"])[1]'))

    'To locate rows of table it will Capture all the rows available in the table'
    List<WebElement> rows_table = Table.findElements(By.xpath('//table[@class="quick-receipt-table"]//tbody//tr//td'))
