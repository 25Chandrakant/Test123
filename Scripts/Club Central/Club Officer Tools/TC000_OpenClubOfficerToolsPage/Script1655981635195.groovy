...
try {
   ...
   // WebUI.click(findTestObject('Object Repository/ClubCentral/Leadership-Home/i_Club Success Plan_fa fa-close'), FailureHandling.OPTIONAL)
    ...
    if (WebUI.getUrl() == 'http://dashboards.toastmasters.org/ClubReport.aspx') {
        ...
        GlobalVariable.varpassremarks = 'User Successfully landing on Club Officer Tools page.'
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to Club Officer Tools page.'
    }
