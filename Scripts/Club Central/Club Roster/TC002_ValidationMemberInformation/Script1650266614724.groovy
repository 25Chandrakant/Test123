...
try {
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Club_Roster/MemberInformation_Popup/li_Please fill out this field'))) {
        WebUI.click(findTestObject('Object Repository/ClubCentral/Club_Roster/MemberInformation_Popup/button_Cancel'))
