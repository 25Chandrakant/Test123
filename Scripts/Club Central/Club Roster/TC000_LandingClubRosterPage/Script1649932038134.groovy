...
try {
   ...
   WebUI.delay(2)
    ...
    WebUI.click(findTestObject('Object Repository/ClubCentral/Club_Roster/div_Club Roster'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Club_Roster/h1_Club Roster'))) {
        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'User Successfully landing on Club Roster page.'
    } else {
        print('FAIL...............................')

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to Club Roster Page.'
    }
