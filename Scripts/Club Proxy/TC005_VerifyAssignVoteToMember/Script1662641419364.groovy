...
try {
    ...
    // if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubProxy/button_EditProxy'))) {
    //	WebUI.delay(2)
    ...
    WebUI.click(findTestObject('Object Repository/ClubProxy/select_DropDownForMember'))

    WebUI.delay(2)

    WebUI.click(findTestObject('Object Repository/ClubProxy/option_MemberName'))
    ...
    /* WebDriver driver = DriverFactory.getWebDriver()
            ...
            objSelect.selectByVisibleText('Emile Rodriguez ') // 'Ami Kotecha, PM2' GlobalVariable.TestData['MemberNameOfClub']
	...
	WebUI.click(findTestObject('Object Repository/ClubProxy/random_click'))

    WebUI.scrollToPosition(9000, 9000)

    'Click on Electricl Signature check box'
	
	WebUI.waitForElementClickable(findTestObject('Object Repository/ClubProxy/checkBox_Signature'), 240)
