...
try {
    ...
    WebUI.click(findTestObject('Object Repository/District Central/Pathways Adoption Rates/span_Pathways Adoption Rates'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Pathways Adoption Rates/h1_Pathways Adoption Rate Report'))) {
        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'User Successfully landing on Pathways Adoption Rates Pages'
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unble to landing on Pathways Adoption Rates Pages'
    }
