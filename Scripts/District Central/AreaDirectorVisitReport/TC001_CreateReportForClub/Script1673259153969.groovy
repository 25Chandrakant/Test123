...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/District Central/Area Director Visit Reports/a_schaduleDate') ,GlobalVariable.TestData["CreateScheduleReportDate"] ) //"06/06/2022"
	
    WebUI.click(findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Create Report')  )
    
	if (WebUI.verifyElementVisible( findTestObject('Object Repository/District Central/Area Director Visit Reports/Validation_Message'),FailureHandling.OPTIONAL )) {
    WebUI.click( findTestObject('Object Repository/District Central/Area Director Visit Reports/button_ClosePop-Up')  )
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please note suggestions for the club') , GlobalVariable.TestData["NoteBookDetails"] )  // "All Well"
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please note suggestions for the club (1)') ,GlobalVariable.TestData["NoteBookDetails"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please note suggestions for the club (2)') , GlobalVariable.TestData["NoteBookDetails"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please note suggestions for the club (3)'), GlobalVariable.TestData["NoteBookDetails"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please note suggestions for the club (4)'), GlobalVariable.TestData["NoteBookDetails"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please note suggestions for the club (5)'), GlobalVariable.TestData["NoteBookDetails"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_What suggestions,do you have') , GlobalVariable.TestData["NoteBookDetails"])
    WebUI.click(findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Save and Continue (3)')  )
    'Club Experience' // OThank you for completing the Club Experience portion of the Area Director Visit Report.
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/input_What are these goals') , GlobalVariable.TestData["NoteBookDetails"])
    WebUI.delay(3)
	WebUI.click(findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Save and Continue (5)')  )
    ...
    WebUI.sendKeys(  findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_GoalOrMilestones') , GlobalVariable.TestData["NoteBookDetails"])
    WebUI.click(  findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Save and Continue (6)')  )
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/input_Event Name') , GlobalVariable.TestData["EventName"])
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/input_Event Date') , GlobalVariable.TestData["EventDate"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_SpecificChallengesOrAreaOfAdditional') , GlobalVariable.TestData["NoteBookDetails"])
    ...
    WebUI.sendKeys( findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please specify')  , GlobalVariable.TestData["NoteBookDetails"])
    WebUI.click(  findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Save and Continue (1)'))
    ...
    'Club Concerns'
    WebUI.sendKeys(findTestObject('Object Repository/District Central/Area Director Visit Reports/textarea_Please specify (1)'), GlobalVariable.TestData["NoteBookDetails"])
