...
try {
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Area Director Visit Reports/span_Select a Club'))) {
        ...
        if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Review and Confirm'))) {
            WebUI.click(findTestObject('Object Repository/District Central/Area Director Visit Reports/button_Review and Confirm'))
        } else if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Area Director Visit Reports/Validation_Message') )) {
        ...
        WebUI.click(findTestObject('District Central/Area Director Visit Reports/a_ClubSelect2'))
    }
