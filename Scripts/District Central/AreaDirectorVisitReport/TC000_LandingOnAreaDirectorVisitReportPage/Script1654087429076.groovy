...
try 
{
	...
	if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Area Director Visit Reports/text_DistrictNameVerify')))
	{
		
		GlobalVariable.vartestresult = 'PASS'
		
		GlobalVariable.varpassremarks = 'User Succesfully navigate to District Central Page'
	...
	} else 
	{
		...
		GlobalVariable.varfailremarks = 'User not able to navigate on their desired District Page'
	}
		WebUI.click(findTestObject('Object Repository/District Central/Area Director Visit Reports/tile_ADVRClick'))
