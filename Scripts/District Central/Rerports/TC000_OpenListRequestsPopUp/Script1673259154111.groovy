...
try {
    ...
    WebUI.click(findTestObject('Object Repository/District Central/Reports/span_Reports'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Reports/h4_List Requests'))) {
        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'Successfully open List Request pop box'
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'Not open List Request pop box.'
    }
