...
try {
    ...
    WebUI.click(findTestObject('Object Repository/District Central/Distinguished Performance Report/span_Distinguished Performance Report'))
    ...
    Select objSelect = new Select(driver.findElement(By.id('cpContent_TopControls1_ddlDistricts')))

    objSelect.selectByVisibleText('District 01')

    Thread.sleep(3000000)

    if (WebUI.getUrl().contains('District')) {
        ...
        GlobalVariable.varpassremarks = 'Successfully open Distinguished Performance Report'
    } else {
        print('FAIL...............................')

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'Not open Distinguished Performance Report.'
    }
