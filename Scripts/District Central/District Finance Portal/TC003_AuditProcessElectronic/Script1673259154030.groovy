...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/District Central/District Finance Portal/a_CompletedAutitGuidelines'), 
        'D:\\GitProject\\290h-moments-of-truth-handout_2021.pdf')
