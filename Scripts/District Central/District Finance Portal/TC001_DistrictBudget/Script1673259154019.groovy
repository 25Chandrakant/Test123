...
try {
	...
	WebUI.delay(2)
	WebUI.uploadFile(findTestObject('Object Repository/District Central/District Finance Portal/upload_SubmitBudget') , 'D:\\GitProject\\290h-moments-of-truth-handout_2021.pdf')//GitProject
