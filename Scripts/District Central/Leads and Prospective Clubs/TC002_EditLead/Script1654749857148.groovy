...
try {
	...
	WebUI.delay(2)
	// Search record
    WebUI.sendKeys(findTestObject('Object Repository/District Central/Leads_ProspectiveClub/Leads and Prospective Clubs/input_Search_form-control input-sm') , "Akash123@gmail.com")
