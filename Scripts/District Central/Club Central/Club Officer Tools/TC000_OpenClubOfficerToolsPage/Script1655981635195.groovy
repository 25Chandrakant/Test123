...
try {
    ...
    WebUI.click(findTestObject('Object Repository/ClubCentral/Club Officer Tools/div_Club Officer Tools'))

    if (WebUI.getUrl() == 'http://dashboards.toastmasters.org/ClubReport.aspx') {
        WebUI.back()
