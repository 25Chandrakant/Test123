...
try {
    ...
    WebUI.click(findTestObject('Object Repository/ClubCentral/Eligibility Assistant/div_Eligibility Assistant'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Eligibility Assistant/h1_Tag'))) {
        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'User successfully go to Eligibility Assistant page.'
    } else {
        print('FAIL...............................')

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to Eligibility Assistant page.'
    }
