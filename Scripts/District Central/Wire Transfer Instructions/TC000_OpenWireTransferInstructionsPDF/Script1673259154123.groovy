...
try {
    ...
    WebUI.click(findTestObject('Object Repository/District Central/Wire Transfer Instructions/span_Wire Transfer Instructions'))

    WebUI.delay(5)

    WebUI.switchToWindowIndex(0)

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/Wire Transfer Instructions/span_Wire Transfer Instructions'))) {
        WebUI.delay(10)
		print('PASS...............................')
		
        GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'Successfully open wire transfer instruction pdf into new tab'
    } else {
        print('FAIL...............................')

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'Not open wire transfer instruction pdf into new tab.'
    }
