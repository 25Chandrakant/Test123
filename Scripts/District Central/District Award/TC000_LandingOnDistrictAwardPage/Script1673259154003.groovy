...
try {
    ...
    WebUI.click(findTestObject('Object Repository/District Central/District Awards/span_District Awards'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/District Central/District Awards/h1_District Awards'))) {
 		 GlobalVariable.vartestresult = 'PASS'

        GlobalVariable.varpassremarks = 'User Successfully landing on District Awards page.'
    } else {
 
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'User unable go to District Awards page.'
    }
