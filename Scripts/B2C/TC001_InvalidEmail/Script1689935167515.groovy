...
try {
    ...
    WebUI.setText(findTestObject('B2C/input_B2CEmail'), 'PN-07939206')
	...
	String invaCre = WebUI.getText(findTestObject('Object Repository/B2C/div_InvalidEmail'))

    Thread.sleep(200)

    if (invaCre == 'Please enter a valid email address') {
