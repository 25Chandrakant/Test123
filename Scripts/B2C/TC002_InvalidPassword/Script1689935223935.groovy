...
try {
    ...
    WebUI.setText(findTestObject('B2C/input_B2CPassword'), 'password')
	...
	String pass = WebUI.getText(findTestObject('Object Repository/B2C/div_InvalidPassword'))

    Thread.sleep(200)

    if (pass == 'Your password is incorrect') {
