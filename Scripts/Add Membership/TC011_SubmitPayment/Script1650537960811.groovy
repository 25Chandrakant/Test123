...
try {
    ...
    //   , "2024", false )
	//WebUI.clearText( findTestObject('Object Repository/Common/Payment_CreditCard/input__NameOnCard')  )
    ...
    if (WebUI.waitForElementVisible(findTestObject('Object Repository/ClubCentral/Add_Membership/No, Dual_Reinstated Member/Return To Club Central'),130)) {
       
	 
		 WebUI.click(findTestObject('Object Repository/ClubCentral/Add_Membership/No, Dual_Reinstated Member/Return To Club Central'))
