...
try {
    ...
    CustomKeywords.'com.application.DPOSCustomKeyword.needSomeHelpCloseButton'()
	 ...
	 WebUI.click( findTestObject('ClubCentral/Submit Payment/button_EditCart')   , FailureHandling.OPTIONAL)

	 "Create Custom Invoice"
	 WebUI.click( findTestObject('Object Repository/ClubCentral/Submit Payment/button_CreateCustomInvoice')  )
	 WebUI.switchToWindowIndex(0)
	 
	 WebUI.verifyElementVisible( findTestObject('Object Repository/ClubCentral/Submit Payment/button_CancelPendingOrder')  )
    ...
    if ( WebUI.waitForElementVisible( findTestObject('Object Repository/ClubCentral/Submit Payment/text_ValidationForCancelPendingOrder'),150  )) {
