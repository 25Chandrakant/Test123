...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/ClubCentral/Add_Membership/No, Dual_Reinstated Member/input__PrimaryEmail'), 
        GlobalVariable.TestData['AlreadyExistEmailID'])

    WebUI.click(findTestObject('Object Repository/ClubCentral/Add_Membership/Address/button_Submit'))

    'Email Address Verify '
    WebUI.verifyElementVisible(findTestObject('Object Repository/ClubCentral/Add_Membership/Yes, New Member/Validation_PrimaryValidation'))
