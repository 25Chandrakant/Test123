...
try {
    ...
    WebUI.setText(findTestObject('Object Repository/Login/input__UserName'), GlobalVariable.TestData['EmailId'])
    ...
    Thread.sleep(200)
        ...
        WebUI.click(findTestObject('Object Repository/Login/i_MyHomeDrpDwn'))
		
		WebUI.delay(2)
		
		WebUI.click(findTestObject('Object Repository/Login/a_MyHome'))
