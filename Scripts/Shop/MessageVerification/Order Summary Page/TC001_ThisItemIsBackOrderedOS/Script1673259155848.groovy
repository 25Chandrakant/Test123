...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/input_Browse Products_txtKeyword'), 
        GlobalVariable.TestData['CSP_OSBackOrderedAPNC'])
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object aRepository/Shop/VerifyMessage/Page_Toastmasters International -Shop/button_MySelf'))) {
        WebUI.click(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/button_MySelf'))
    }
    
    String thisItemBackOreded = WebUI.getText(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/span_This item is on backorder'))
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/span_This item is on backorder'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on order summary page like.' + thisItemBackOreded)
    } else if (thisItemBackOreded == null) {
        WebUI.click(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/button_Cart'))
        ...
        GlobalVariable.varfailremarks = ('Not display display message on order summary page because the value is..' + thisItemBackOreded)
    } else {
        WebUI.click(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/button_Cart'))
        ...
        GlobalVariable.varfailremarks = ('Not display display message on order summary page like.' + thisItemBackOreded)
    }
