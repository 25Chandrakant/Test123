...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/input_Browse Products_txtKeyword'), 
        GlobalVariable.TestData['CSP_ISPNC'])
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_In Stock'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on order summary page like' + inStock)
        ...
        GlobalVariable.varfailremarks = ('Not display message on order summary page because the value is.' + inStock)
    } else {
        WebUI.click(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/button_Cart'))
        ...
        GlobalVariable.varfailremarks = ('Not display message on order summary page like' + inStock)
    }
