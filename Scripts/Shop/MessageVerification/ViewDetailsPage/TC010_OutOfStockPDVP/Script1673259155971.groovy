...
try {
    ...
    String onlyLeft = WebUI.getText(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_OutOfStock'))
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_OutOfStock'))) {
        ...
        GlobalVariable.varfailremarks = ('Not display message on product details view page for item no. is B2.' + onlyLeft)
    }
