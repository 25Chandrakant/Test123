...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/input_Browse Products_txtKeyword'), 
        GlobalVariable.TestData['PDVP_MQBNAPNDPNC'])
	...
	String itemNoLongerAvailable = WebUI.getText(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_Item is out of stock and no longer available'))
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_Item is out of stock and no longer available'))) {
        ...
        GlobalVariable.varpassremarks = 'Successfully display message on product view details page like' +itemNoLongerAvailable
    } else {

        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'Not display message on product view details page like' +itemNoLongerAvailable
    }
