...
try {
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/span_This item is on backorder'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on product details view page for item no. is 393MI.' + 
        ...
        GlobalVariable.varfailremarks = ('Not display message on product details view page for item no. is 393MI.' + thisItemOnBackOrdered)
    }
