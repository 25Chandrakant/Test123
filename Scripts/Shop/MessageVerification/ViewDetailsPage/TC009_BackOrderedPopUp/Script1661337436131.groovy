...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/input_Browse Products_txtKeyword'), 
        GlobalVariable.TestData['PDVP_MQBAPNCBackordered'])
    ...
    String thisItemOnBackOrdered = WebUI.getText(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_Backordered'))
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_Backordered'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on product details view page for item no. is 1726.' + 
        thisItemOnBackOrdered)
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = ('Not display message on product details view page for item no. is 1726.' + thisItemOnBackOrdered)
    }
