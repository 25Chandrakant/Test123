...
try {
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/span_This item is on backorder'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on product listing page like' + itemsIsBackOrdered)
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = ('Not display message on product listing page like' + itemsIsBackOrdered)
    }
