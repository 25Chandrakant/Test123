...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/input_Browse Products_txtKeyword'), 
        GlobalVariable.TestData['YOCS_MQBNAPDPNC'])
    ...
    String productDiscontinued = WebUI.getText(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_This product is discontinued'))
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_This product is discontinued'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on cart summary like.' + productDiscontinued)
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = ('Not display message on cart summary page like' + productDiscontinued)
    }
