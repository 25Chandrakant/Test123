...
try {
    ...
    WebUI.sendKeys(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/input_Browse Products_txtKeyword'), 
        GlobalVariable.TestData['YOCS_INBAPNC_SEELeftQuantitySEE'])
    ...
    String outOfStock = WebUI.getText(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_OutOfStock'))

    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/VerifyMessage/Page_Toastmasters International -Shop/p_OutOfStock'))) {
        ...
        GlobalVariable.varpassremarks = ('Successfully display message on cart page like .' + outOfStock)
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = ('Not display message on cart page like .' + outOfStock)
    }
