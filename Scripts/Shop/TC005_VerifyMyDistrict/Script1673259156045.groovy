...
try {
    ...
    WebUI.waitForElementVisible(findTestObject('Object Repository/Shop/k -Shop/input_Search Text_form-control input-sm'), 
        120)

    WebUI.click(findTestObject('Object Repository/Shop/k -Shop/input_Search Text_form-control input-sm'))

    WebUI.sendKeys(findTestObject('Object Repository/Shop/k -Shop/input_Search Text_form-control input-sm'), GlobalVariable.OrderIDDistrict)

    String orderVerifyDistrict = WebUI.getText(findTestObject('Object Repository/Shop/k -Shop/td_SO-000000002172'))

    if (orderVerifyDistrict == GlobalVariable.OrderIDDistrict) {
