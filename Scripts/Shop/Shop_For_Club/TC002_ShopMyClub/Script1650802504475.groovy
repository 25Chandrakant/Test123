...
try {
	...
	{
		String orderIdClub = WebUI.getText(findTestObject('Object Repository/Shop/text_VerifyOrderRefNum'))

		println('................................' + orderIdClub)

		String clubFinalOrderID = orderIdClub.substring(17)

		GlobalVariable.OrderIDClub = clubFinalOrderID

		GlobalVariable.vartestresult = 'PASS'
		
		GlobalVariable.varfailremarks = 'Order is successfully created for MyClub'
	}
	else
	{
