...
try {
	...
	WebUI.waitForElementClickable(findTestObject('Object Repository/Pathway/tile_LearningHub'), 240)
	  
    WebUI.click(findTestObject('Object Repository/Pathway/tile_LearningHub'))
	  
	WebUI.delay(2)

	WebUI.click(findTestObject('Object Repository/Pathway/OnBehalf/tile_BuyAMembersPath'))
	  
	WebUI.delay(10)
	
	WebUI.click(findTestObject('Object Repository/Pathway/OnBehalf/drpdown_SelectMember'))
	
	WebUI.delay(2)

    WebUI.click(findTestObject('Object Repository/Pathway/OnBehalf/option_MemberName'))

    WebUI.delay(2)

    //WebUI.click(findTestObject('Object Repository/Pathway/OnBehalf/drpdown_SelectLanguage'))
	
	//WebUI.delay(2)
	
	//WebUI.click(findTestObject('Object Repository/Pathway/OnBehalf/option_English'))
	
	//WebUI.delay(5)
	
	WebUI.click(findTestObject('Object Repository/Pathway/OnBehalf/button_Continue'))
	...
	WebUI.waitForElementVisible(findTestObject('My Home/My Downloads/a_Next'), 240)
	...
	WebUI.waitForElementVisible(findTestObject('My Home/My Downloads/a_NextButtonOfPayment'), 240)
	...
	WebUI.waitForElementVisible(findTestObject('My Home/My Downloads/a_PlaceYourOrder'), 240)
   ...
   //     if ((digitalordernumber == GlobalVariable.PrintedPathWayOrderNumber) && (digitalordervalue == GlobalVariable.PrintedPathwayOrderValue)) {
	...
	//		WebUI.delay(3)
		    ...
		    GlobalVariable.varpassremarks = 'User Successfully purchase pathway on behalf of member.'
