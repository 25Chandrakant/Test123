...
try {
	...
	WebUI.waitForElementVisible(findTestObject('Object Repository/ATO/a_NewApplicationToStart'), 120)
	
	WebUI.click(findTestObject('Object Repository/ATO/a_NewApplicationToStart'))
