...
try {
...

	{
		...
		WebUI.mouseOver(findTestObject('Object Repository/SelfPay/Add Membership/No,Dual_ReinstateMember/li_May'))

		WebUI.delay(2)
		
		WebUI.click(findTestObject('Object Repository/SelfPay/Add Membership/No,Dual_ReinstateMember/li_May'))
		...
		WebUI.mouseOver(findTestObject('Object Repository/SelfPay/Add Membership/No,Dual_ReinstateMember/li_September'))
		
		WebUI.delay(2)
		
		WebUI.click(findTestObject('Object Repository/SelfPay/Add Membership/No,Dual_ReinstateMember/li_September'))

		//WebUI.click(findTestObject('SelfPay/Membership Cart/button_EndDateDropDown'), 'September 30,2023')
		...
		WebUI.mouseOver(findTestObject('Object Repository/SelfPay/Add Membership/No,Dual_ReinstateMember/li_April'))
		
		WebUI.delay(2)
		
		WebUI.click(findTestObject('Object Repository/SelfPay/Add Membership/No,Dual_ReinstateMember/li_April'))
		...
		//WebUI.mouseOver(findTestObject('Object Repository/SelfPay/Review Order/a_ContinueToPayment'))
		
		WebUI.waitForElementVisible(findTestObject('Object Repository/SelfPay/Review Order/a_ContinueToPayment'), 120)
	...
	else
	{
     ...
     WebUI.waitForElementVisible(findTestObject('Object Repository/SelfPay/Common Functionality/text_MembershipPaymentId'), 240)	
		...
		if (WebUI.verifyElementVisible(findTestObject('Object Repository/SelfPay/Common Functionality/text_MembershipPaymentId'))) {
			...
			WebUI.click(findTestObject('Object Repository/SelfPay/Yes,NewMember/a_ReturnToManagementPage'))
