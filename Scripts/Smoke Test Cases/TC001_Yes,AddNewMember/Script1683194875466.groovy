...
try {
	...
	if (WebUI.verifyElementVisible(findTestObject('Object Repository/SelfPay/Yes,NewMember/select_Island'))){
	
	WebUI.click(findTestObject('Object Repository/SelfPay/Yes,NewMember/select_Island'))
	
	WebUI.delay(3)

	WebUI.click(findTestObject('Object Repository/SelfPay/Yes,NewMember/option_Value'))
