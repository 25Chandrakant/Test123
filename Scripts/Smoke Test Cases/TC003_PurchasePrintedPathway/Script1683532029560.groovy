...
try {
    ...
    WebUI.click(findTestObject('Object Repository/Pathway/Select_Printed_PathWay/h3_ViewAllPath'))
	...
	WebUI.waitForElementClickable(findTestObject('My Home/My Downloads/a_Next'), 120)
	...
	WebUI.waitForElementClickable(findTestObject('My Home/My Downloads/a_NextButtonOfPayment'), 120)
	...
	WebUI.waitForElementClickable(findTestObject('My Home/My Downloads/a_PlaceYourOrder'), 120)
