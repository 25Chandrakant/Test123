...
try {
	...
	WebUI.delay(5)
    WebUI.sendKeys(findTestObject('Object Repository/Login/input__UserName'), 'PN-67510904')
	...
	WebUI.delay(5)
    WebUI.sendKeys(findTestObject('Object Repository/Login/input__Password'), 'password')
