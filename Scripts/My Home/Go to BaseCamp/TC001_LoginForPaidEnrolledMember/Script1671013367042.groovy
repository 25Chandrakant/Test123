...
try {
	...
	WebUI.click(findTestObject('Object Repository/Login/input__UserName'))
	
	WebUI.delay(5)
    WebUI.sendKeys(findTestObject('Object Repository/Login/input__UserName'), 'muglooneha@gmail.com')

   // WebUI.mouseOver(findTestObject('Object Repository/Login/input__Password') )
	
	WebUI.click(findTestObject('Object Repository/Login/input__Password'))
	
	WebUI.delay(5)
    WebUI.sendKeys(findTestObject('Object Repository/Login/input__Password'), 'Password1!')
