...
try {
	...
	WebUI.click(findTestObject('ATO/New_ATO/ValidateAddress'))
	
	WebUI.delay(20)
	
	WebUI.click(findTestObject('Object Repository/ATO/New_ATO/button_ContinuePayment'))
	
	WebUI.delay(20)
	
	'Payment Method'
	WebUI.click(findTestObject('ATO/New_ATO/button_Creditcard'))
