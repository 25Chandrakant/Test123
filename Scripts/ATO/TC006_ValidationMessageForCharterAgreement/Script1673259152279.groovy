...
try {
	...
	String validationMessage = WebUI.getText(findTestObject('Object Repository/ATO/a_ValidationForCharterAgreement'))

	if (validationMessage.contains('Sponsoring Club')) {
