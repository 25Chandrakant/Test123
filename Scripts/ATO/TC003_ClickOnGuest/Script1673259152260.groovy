...
try {
    ...
    WebUI.click(findTestObject('Object Repository/ATO/input_button_ContinueAsGuest'))
   
   
    String headerName = WebUI.getText( findTestObject('Object Repository/ATO/text_ATO Text') )
