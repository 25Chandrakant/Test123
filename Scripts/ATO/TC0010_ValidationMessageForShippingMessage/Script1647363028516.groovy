...
try {
	...
	WebUI.click(findTestObject('Object Repository/ATO/button_ShippingContinue'))
	
	
	 String validationMessage = WebUI.getText(findTestObject('Object Repository/ATO/button_ShippingContinue'))

   // print(validationMessage)

    if (validationMessage.contains('Continue')) {
