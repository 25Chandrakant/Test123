...
try {
    ...
    if (WebUI.verifyElementVisible(findTestObject('Object Repository/Shop/Page_Receipt/h2_Order Reference SO-000000002151'))) {
        ...
        GlobalVariable.varpassremarks = ('Order Created  successfully for Engraving Optional Product : ' + Orderid)
    } else {
        GlobalVariable.vartestresult = 'FAIL'

        GlobalVariable.varfailremarks = 'Order is not created for Engraving Optional Product .'
    }
