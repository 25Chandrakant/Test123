...
try {
	...
	//WebUI.sendKeys(findTestObject('Object Repository/SelfPay/Submit Payment/input_CreditCardNumber'), GlobalVariable.TestData['cardNumber'])
	...
	//WebUI.sendKeys(findTestObject('Object Repository/SelfPay/Submit Payment/input_CreditCardNumber'), Keys.chord(Keys.ENTER))
